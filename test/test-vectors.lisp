...
(defparameter *p17-order* 19)

(defparameter *p17-points* '((5 1)
                            (6 3)
                            (10 6)
                            (3 1)
                            (9 16)
...
(defparameter *nistp192-mulpoints* (make-hash-table))
...
(defparameter *nistp192-ecdsa-tests-list* '(
...
(defparameter *nistp192-ecdsa-tests* '())
