...
(defgeneric as-int (accessor Object)
  (:documentation "Reads the corresponding slot (byte-array) and returns the integer value"))
...
(defmethod as-int (accessorfn (ec Curve))
  (ironclad:octets-to-integer (funcall accessorfn ec)))
(defmethod as-int (accessorfn (pt Point))
  (ironclad:octets-to-integer (funcall accessorfn pt)))
